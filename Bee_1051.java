...
public class Bee_1051 {
	...
	é o Rombus, cujo símbolo é o R$.

	Leia um valor com duas casas decimais, equivalente ao salário de 
	uma pessoa de Lisarb. Em seguida, calcule e mostre o valor que 
	esta pessoa deve pagar de Imposto de Renda, segundo a tabela 
	abaixo.
	...
	entrada for menor ou igual a 2000, deverá ser impressa a mensagem 
	"Isento".
	...
	*/
	...
	if ((salario > 0.00) && (salario <= 2000.00)) {
		...
		irpf = (salario - 2000.00)*0.08;
		}
	else if (salario <= 4500.00){
		irpf = (salario - 3000.00)*0.18 + (3000.00-2000.00)*0.08;
	}
	else {
		irpf = (salario - 4500.00)*0.28 + (4500.00-3000.00)*0.18 + (3000.00-2000.00)*0.08;
		}
